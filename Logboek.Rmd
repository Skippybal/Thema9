...
```
Looking at the structure of the data in table 2, it seems like all of the columns have been read and have the right datatype.
...
ggscatter(
  ...
  labs(tag = "Figure 11: PCA based on K-means clustering",
